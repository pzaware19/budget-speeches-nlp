...
1. **Once you control for time, BJP and INC budget speeches are statistically indistinguishable.** Every topic, every estimate, every confidence interval crosses zero. Finance Ministers from both parties, when governing in the same economic era, reach for the same fiscal vocabulary.

2. **Ten coherent themes fall out of the corpus without any labelling.** The post-Partition currency crisis. The Green Revolution. The 1991 foreign exchange emergency. The NABARD-SSI-rural credit era. The GST and Aadhaar decade. These are not categories I imposed; the algorithm found them.

3. **The identification problem is fundamental and probably unfixable with this data.** INC governed from 1947 to 2004 with brief interruptions. BJP has governed since 2014. The party you belong to and the decade you govern in are nearly the same variable. Any apparent difference in vocabulary between BJP and INC speeches could just as easily be an era difference.
:::
