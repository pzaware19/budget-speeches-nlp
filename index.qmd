...
5. **The only reliable vocabulary trend in Sitharaman's eight budgets is manufacturing/PLI (R²=0.67).** Green and climate vocabulary peaked in 2022-23 after COP26 and has been falling back since. Infrastructure vocabulary peaked in 2021 and is declining. Manufacturing and production-linked incentive language is the one theme that has risen consistently; it is the most defensible projection for 2027-28.
:::
...
![The dominant vocabulary of each political era: word size reflects relative frequency within that era's speeches. Colours are illustrative, not party-coded.](output/figures/fig_era_wordclouds.png){width=100% .era-img}
...
![All 76 full budget speeches (1947-2026) plotted in the 2D ideology space. Colour encodes decade. The shift from the socialist-nationalist quadrant in the 1950s-70s toward the market-liberal quadrant after 1991 is the dominant structural change in the corpus.](output/figures/fig_ideology_art.png){width=100% .ideology-art}
...
## What the Data Predicts for 2027 {#prediction}

Sitharaman has now given eight full budget speeches: 2019-20 through 2026-27. That is enough data to ask whether her budgets follow any detectable trajectory, and if so, where that trajectory points.

This is a structured extrapolation, not a machine learning forecast. I count how often six policy-theme word groups appear per 1,000 words in each of her speeches, fit a linear trend to those eight observations, and project the line one year forward. The word counts use the full cleaned speech text with an expanded set of Part B tax boilerplate removed so the denominators are comparable across years. Where the linear fit is poor (low R-squared), the projection is flagged as unreliable.

### The only reliable trend: Manufacturing and PLI

![Policy theme vocabulary across Sitharaman's eight full budget speeches. Dashed lines are linear trend fits. Manufacturing/PLI and Fiscal/Deficit are the only themes with R² above 0.3, meaning the other lines are closer to noise than trend.](output/figures/fig_ns_vocab_trend.png){width=100%}

The manufacturing and production-linked incentive vocabulary (words like *manufacturing, pli, atmanirbhar, msme, capacity, exports, domestic, industrial*) has risen consistently across her eight budgets, from around 6.7 per 1,000 words in 2019-20 to 15.4 per 1,000 in 2026-27. The linear trend fits with R²=0.67, the highest in the dataset. This is the one number you can project forward with some confidence: the 2027-28 budget will almost certainly continue or extend the manufacturing and PLI emphasis, not retreat from it.

The fiscal consolidation vocabulary (*fiscal, deficit, capex, gdp, consolidation, borrowing*) has also risen substantially since 2019-20, from about 2.9 per 1,000 words to 10.7 per 1,000 in 2026-27, a near-fourfold increase. R²=0.37. The direction is clear but the year-to-year variation is large enough that the 2027 projection (around 11.3 per 1,000) carries a wide confidence band.

### What has peaked and is now declining

Two themes tell an interesting story about political timing. Green and climate vocabulary spiked sharply in 2022-23 and 2023-24, the two budgets following COP26 in Glasgow and India's net-zero commitment. By 2026-27 the green vocabulary had fallen back to near its 2019-20 baseline (3.9 per 1,000 words, roughly where it started). The linear trend across all eight years appears slightly positive, but that is an artefact of the peak years pulling up the regression line. The true pattern is an inverted U, not a rise: the climate language responded to a specific political moment and has since receded.

Infrastructure vocabulary follows a similar arc: it peaked in 2021-22 (15.4 per 1,000 words, reflecting the post-COVID capital expenditure push) and has trended downward since, reaching 6.0 per 1,000 in 2026-27. The physical infrastructure push of the early 2020s appears to be yielding floor space to manufacturing and fiscal consolidation as the dominant economic narrative.

### What the data cannot detect

Digital and technology vocabulary shows no meaningful trend: R²=0.03, oscillating between 4 and 16 per 1,000 words with no direction. Welfare and social spending vocabulary is the largest theme by volume (consistently 16-28 per 1,000 words, reflecting how much of every budget speech is about schemes for farmers, women, and the poor), but also highly variable. Neither can be projected with any confidence. Expect both to continue at roughly their 2026-27 levels.

### Prediction for 2027-28

![Predicted policy theme emphasis for Sitharaman's 2027-28 budget. Bars show linear trend projections; error bars are 80% prediction intervals. Only themes with R² above 0.3 should be read as credible point estimates. The others are best interpreted as "stable at recent levels."](output/figures/fig_prediction.png){width=90%}

The credible forecast, limited to the two themes with meaningful R²:

- **Manufacturing/PLI vocabulary will continue rising.** Projected around 20-21 per 1,000 words (from 15.4 in 2026-27). The 80% prediction interval runs from 14.7 to 26.3. This is the single most reliable quantitative signal in the data.
- **Fiscal consolidation language will hold or modestly increase.** Projected around 11 per 1,000 words (from 10.7 in 2026-27). The direction is consistent; the magnitude is uncertain.

For everything else, the honest forecast is continuity at recent levels, not a meaningful directional prediction.

### Ideology: stable

The ideology scores show no directional trend. The market-liberal axis has R²=0.16 and the nationalist axis R²=0.05. Both are essentially stable; they fluctuate year to year without a consistent direction.

![Nirmala Sitharaman's ideology scores across her eight full budgets, with 2027-28 projected values (red triangles). Both trend lines are nearly flat, with wide prediction intervals.](output/figures/fig_ns_ideology_trend.png){width=90%}

The ideological register that characterised her 2026-27 budget, moderately market-liberal on capital and deregulation and moderately nationalist on manufacturing and import duties, is the best predictor of her 2027-28 ideological register. The vocabulary mix will depend more on the macro environment at budget time than on any detectable long-run drift.

::: {.callout-note}
**On the sample.** Eight speeches from one Finance Minister is a small dataset. A single unusual year (a crisis budget, a pre-election reversal, a global shock) can materially shift a linear trend. Treat the manufacturing and fiscal projections as informed extrapolations, not forecasts. The 80% prediction intervals are wide for a reason.
:::

## Do Budget Speeches Predict Fiscal Outcomes? {#words-money}

A budget speech is a commitment device. The Finance Minister announces priorities, names schemes, and describes the fiscal trajectory. But do the words actually track the money? Does a speech heavy with infrastructure vocabulary predict higher public investment? Does fiscal/deficit rhetoric signal a tighter or looser fiscal stance in that year?

This analysis matches vocabulary theme scores for all 76 full budget speeches (1960-2026) against seven World Bank fiscal indicators for India: military expenditure, education spending, health spending, gross fixed capital formation, the fiscal deficit, renewable electricity share, and FDI inflows.

### The main result: most raw correlations are spurious

The raw correlation between infrastructure vocabulary and gross fixed capital formation (GFCF) is striking: R²=0.54 across 61 years. The market-liberal ideology score also correlates strongly with FDI inflows (R²=0.18). But both of these relationships largely disappear once a common year trend is removed from both series.

![Scatter plots: vocabulary theme scores vs fiscal outcomes (all years). OLS line with 95% CI. Year labels mark decadal observations.](output/figures/fig_vocab_fiscal_scatter.png){width=100%}

Infrastructure vocabulary and investment have both trended upward since 1960. The market-liberal ideology score and FDI inflows have both trended upward since 1991. The raw correlation captures this common direction, not a genuine year-to-year relationship between rhetoric and allocation. Once the shared time trend is partialled out, infrastructure vocabulary R² drops from 0.54 to 0.02 (p=0.24).

### Two correlations that survive detrending

After removing year trends from both the vocabulary scores and the fiscal outcomes, two relationships remain statistically significant.

**Fiscal/deficit vocabulary and the actual fiscal deficit** (R²=0.11, p=0.031, N=42 years). In years when the budget speech contains more deficit/fiscal/consolidation terminology than its trend predicts, the actual fiscal deficit as a share of GDP is also higher than its trend. The direction is plausible: Finance Ministers who face larger deficits are forced to address them in the speech, and the vocabulary responds. This is not evidence that talking about deficits causes them; it is evidence that the rhetoric accurately signals the fiscal situation the FM is describing.

**Green/climate vocabulary and renewable electricity deployment** (R²=0.15, p=0.042, N=28 years). Years with above-trend green vocabulary in the budget speech are years with above-trend renewable electricity as a share of total power generation. This co-movement persists after removing the common upward trend in both series.

The FDI/openness vocabulary borderline correlates with FDI inflows (R²=0.07, p=0.07) and welfare vocabulary borderline correlates with education spending (R²=0.18, p=0.07), but these do not survive a standard significance threshold.

### Do speeches predict future spending (beyond persistence)?

The harder test: does vocabulary in year t predict fiscal outcomes in year t, controlling for the fiscal outcome in year t-1? If the speech contains genuine forward-looking information, it should add predictive power beyond what past spending already implies.

![Does last year's speech predict this year's fiscal outcomes? Coefficient on vocab_{t-1} in a regression that also controls for fiscal_{t-1}. Green filled dots are p<0.05; open dots are n.s.](output/figures/fig_text_leads_forest.png){width=90%}

No vocabulary theme produces a significant positive coefficient in this specification. The closest is welfare vocabulary marginally predicting education spending at p=0.07, but with a negative coefficient: more welfare vocabulary is associated with slightly lower education spending the following year, not higher. That sign is difficult to interpret and may reflect composition effects.

### The causal direction: money leads words, not words to money

The most significant finding in the dynamic regressions runs the other way: past fiscal outcomes predict future vocabulary. Higher investment spending in year t-1 predicts more infrastructure vocabulary in year t, controlling for vocabulary persistence (p=0.005). Past FDI inflows marginally predict more market-liberal rhetoric (p=0.075).

This pattern suggests that budget speech vocabulary is largely **reactive** rather than directive. Finance Ministers describe the fiscal trajectory they have been on, and the vocabulary reflects that trajectory. The speech does not appear to function as a binding commitment that shapes the subsequent allocation.

::: {.callout-note}
**Data limitations.** The WDI fiscal indicators are calendar-year aggregates for India. India's fiscal year runs April to March, so the match to budget speech years (which cover the following fiscal year) is approximate. For broad indicators like military spending and investment, this matters less; for shorter series like health spending (24 years) or education spending (22 years), the estimates are unreliable. The analysis uses only full budget speeches; interim budgets are excluded.
:::

## Do Finance Ministers Drift Ideologically Over Their Tenure? {#trajectory}

If a Finance Minister serves for three, five, or eight budgets, do they drift toward a different ideological position than when they started? Do they become more market-liberal as they settle into the role and build relationships with capital markets? Or does an accumulated political logic pull them back toward redistribution and welfare?

The corpus spans 11 Finance Ministers with three or more full budgets, ranging from Morarji Desai (8 budgets, INC, 1959-1964 and 1967-1969) to Nirmala Sitharaman (8 budgets, BJP, 2019-2026). Fitting a linear trend within each FM's tenure tests whether the ideology score systematically rises or falls over the course of their time in office.

![Finance Minister ideology over tenure. Each point is one full budget speech. Thick trend lines are significant at p<0.1; dashed lines are not. The x-axis is budget number within that FM's tenure, not calendar year.](output/figures/fig_fm_trajectory.png){width=100%}

Most Finance Ministers show no statistically significant ideological drift. Being in office for a fourth or fifth budget does not reliably make a Finance Minister more or less capitalist in their vocabulary.

Two exceptions stand out.

**P. Chidambaram** (INC, 8 full budgets across multiple stints) drifts significantly toward less market-liberal vocabulary over his tenure (slope = -0.0009 per budget, p=0.049, R²=0.50). His early budgets, particularly 1996-97 under the United Front government and his first UPA budget in 2004-05, are relatively market-liberal in vocabulary. By his later UPA budgets (2012-13), the vocabulary has shifted toward welfare and social programmes. Whether this reflects his personal evolution, the political pressures of UPA's coalition arithmetic, or the changing policy agenda is not resolvable from the text alone.

**Yashwant Sinha** (BJP, 4 full budgets, 1998-2002) becomes significantly less nationalist over his tenure on the protectionist axis (slope = -0.0009 per budget, p=0.001, R²=0.998). His first budget in 1998-99 contains substantially more domestic-industry protection and self-reliance vocabulary; by his 2001-02 budget, that vocabulary has receded. The NDA government's trajectory, from the Swadeshi framing of its early phase to the more outward-oriented disinvestment and technology emphasis of the early 2000s, is visible in his individual trajectory.

![Slope of ideological drift per additional budget in tenure. Filled dots are significant at p<0.1. Most FMs cluster near zero on both axes.](output/figures/fig_fm_slope.png){width=100%}

### Does the pre-election budget differ?

Finance Ministers who present both full and interim budgets give us a natural test: does the last full budget before an election year read differently from their earlier budgets? If FMs move toward populism ahead of elections, the pre-election budget (the final full speech before the interim) should score lower on market-liberal vocabulary and possibly higher on welfare rhetoric.

The means go in the expected direction: pre-election full budgets score slightly lower on market-liberal vocabulary (mean 0.00044 vs 0.00178 for other full budgets). But with only six pre-election observations across six Finance Ministers, the difference is not statistically significant (p=0.36). The effect size would need to be much larger to detect it with this sample.

The result is consistent with the interim budget finding from Section 8: electoral pressure shifts the *tone* of fiscal communication but does not systematically reshape its *ideological content*. FMs do not appear to fundamentally rewrite their economic philosophy when an election is approaching.

## Economic Survey vs Budget Speech {#ecosurvey}

The Economic Survey is published the day before the Union Budget. It is written by the Chief Economic Adviser, a technocrat with a degree of analytical independence from the Finance Ministry, while the budget speech is the Finance Minister's political statement. The two describe the same economy in the same week. So a natural question: how much does the budget actually echo the Survey delivered the day before? If the speech closely tracks the Survey, fiscal rhetoric is following the technocratic diagnosis. If it does not, the speech is its own political document.

To measure this I scraped the full Economic Surveys (all chapters, English) from indiabudget.gov.in and computed the TF-IDF cosine similarity between every Survey and every budget speech. Surveys before 1997-98 are scanned images with no extractable text layer on the government's own archive, so the comparison runs **1998 to 2025, 28 years**, spanning six Finance Ministers across both parties rather than a single recent government. The same-year cell, a Survey and the budget it preceded by a day, is the one of interest; every other pairing is the baseline for how similar a Survey is to some *other* year's budget.

![TF-IDF cosine similarity between each full Economic Survey (row) and each budget speech (column), 2019-2025 detail. Darker is more shared distinctive vocabulary. Same-year cells are outlined in red.](output/figures/fig_es_bs_similarity.png){width=100%}

![Same-year cosine similarity (red) against the average similarity to every other year's budget (grey dashed), 1998-2025. Triangles mark the 3 of 28 years where the same-year pair is the closest match in the entire record. Shaded bands are Finance Minister tenures.](output/figures/fig_es_bs_trend_full.png){width=100%}

Two results, and the second is the interesting one. First, the Survey and the budget are broadly similar documents: on overall word usage their cosine similarity averages about 0.5, unsurprising given they share a ministry, an economy, and a moment. Second, across all 28 years, the budget does **not** specifically echo its own Survey more than it echoes other years' Surveys. Same-year similarity on distinctive vocabulary averages 0.191 against an other-year baseline of 0.143, a lift of 1.33 times, and the same-year pair is the closest match in the whole record in only **3 of 28 years**: 2010, 2012, and 2021. The finding from the 2019-2025 window (a 1.13x lift, brightest in row in 2 of 7 years) was not a fluke of the current government; the pattern holds, if anything a little more strongly, across the full post-1998 record.

The full timeline surfaces two outliers the recent-only window couldn't show. **2001 to 2003** (Yashwant Sinha's last budget and Jaswant Singh's first two) is the low point of the entire series: same-year cosine similarity falls to 0.05-0.07, essentially indistinguishable from noise, sitting right on the grey baseline. Whatever that Survey diagnosed, the budget speech was not building its argument from it. **2010 to 2012**, Pranab Mukherjee's UPA-II budgets, is the opposite extreme: same-year similarity climbs to 0.26, then 0.40, then a full 0.45 in 2012, roughly double anything else in the record and nearly three times the contemporaneous baseline. For those three years, and only those three, the budget speech really did read like it was arguing from the Chief Economic Adviser's diagnosis rather than past it. No other Finance Minister in either party, before or since, tracked their own Survey nearly as closely.

The interpretation is the payoff, and it survives the longer time series. You might expect the budget, delivered the morning after the Survey, to read as a restatement of it. For 25 of the last 28 years, the text says it does not. The Finance Minister's speech is its own document, organised around the government's political priorities rather than the Chief Economic Adviser's diagnosis, and that has been true under Sinha, Chidambaram, Jaitley, and Sitharaman alike. Mukherjee's three budgets are the exception that proves it is a choice, not a structural constraint: a Finance Minister who wants the speech to track the Survey closely can make that happen. Most, most years, do not.

::: {.callout-note}
Surveys before 1997-98 could not be included: the PDFs on indiabudget.gov.in's own archive for that period are scanned images with no embedded text layer, and OCR on 30-70-year-old scanned government documents was judged too unreliable for a rigorous word-level comparison rather than attempted and disclosed as noisy. Four budget speeches (2008-09 through 2011-12) were also missing from the underlying corpus used elsewhere on this site; they were separately re-scraped and lightly cleaned for this comparison only, and are not part of the topic-model corpus used in the Topics and Party sections above. The Surveys are also far longer than the speeches (spanning roughly 90,000 to 340,000 words against a speech's 5,000-14,000), which cosine similarity on length-normalised vectors handles but which is worth stating.
:::
