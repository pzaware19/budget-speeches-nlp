...
![Policy theme vocabulary trends across Sitharaman's eight full budget speeches (Part A text). Dashed lines show linear trends. Manufacturing/PLI and Fiscal/Deficit have the highest R-squared values, indicating the most predictable trajectories.](output/figures/fig_ns_vocab_trend.png){width=100%}
...
![Predicted policy theme emphasis for Sitharaman's next budget (2027-28). Bars show linear trend projection; error bars show 80% prediction interval. Colour indicates direction of internal trend.](output/figures/fig_prediction.png){width=90%}
...
![Nirmala Sitharaman's ideology scores across her eight full budgets, with 2027-28 projected values (red triangles). The flat trend lines confirm that her ideological register has been stable, not directional.](output/figures/fig_ns_ideology_trend.png){width=90%}
