...
The Economic Survey is published the day before the Union Budget. It is written by the Chief Economic Adviser (CEA), a technocrat appointed by the government but with a degree of analytical independence from the Finance Ministry. The budget speech itself is drafted by the Finance Minister's team. The two documents address the same economy with potentially different emphases: the CEA's assessment of what is and what should be done, versus the Finance Ministry's political statement of what the government is going to do.

Do the Economic Survey and the Budget Speech sit in the same ideological position? When they diverge, who is more market-liberal?

This analysis uses the same ideology dictionaries applied to Economic Survey PIB press release texts for 2021-2024. Three years have sufficient text for scoring (2021 under K.V. Subramanian; 2023 and 2024 under V. Anantha Nageswaran). Three years is a small sample and the results are directional rather than definitive.

![Economic Survey (circle) vs Budget Speech (square) ideological positions. Arrow points from Budget Speech toward Economic Survey, showing the direction and magnitude of divergence. 2021: Economic Survey is more market-liberal than the Budget. 2023-24: Budget Speech is more market-liberal than the Economic Survey.](output/figures/fig_es_vs_bs.png){width=90%}

**2021 (K.V. Subramanian):** The Economic Survey is more market-liberal than the Budget Speech delivered by Nirmala Sitharaman. The CEA's text uses more private-sector, reform, and efficiency vocabulary relative to the budget's welfare and consolidation emphasis in the post-COVID year.

**2023-2024 (V. Anantha Nageswaran):** The pattern reverses. The Budget Speech is now more market-liberal than the Economic Survey in both years. The CEA's text is relatively more balanced or state-led in its framing, while the budget speech leads with more capitalist vocabulary.

Market axis sign agreement across the three years: 2/3. Nationalist axis: 1/3. The sample is too small to draw firm conclusions, but the reversal in direction between the two CEA regimes is notable.

::: {.callout-note}
The Economic Survey texts here are PIB press release summaries, not the full Economic Survey documents, which run to hundreds of pages. The PIB summaries emphasise highlights rather than the full analytical content. This limits the analysis: the ideology scores are being computed on a summary of the CEA's argument rather than the argument itself. The direction of divergence is interpretable; the magnitude less so.
:::
