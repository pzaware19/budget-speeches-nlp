...
*Method: Linear vocabulary trend (2019-2026) + PRS/EcoSurvey pre-budget signal (2026)*
...
2. **External signal (news themes):** Dominant vocabulary from PRS Legislative
   ...
   most recent year available (2026). This captures what the
...
- **Market-liberal axis:** 0.0063 in 2026 -> projected 0.0064 in 2027 (more market-liberal)
  (R2 = 0.162)
- **Nationalist axis:** 0.0023 in 2026 -> projected 0.001 in 2027 (less nationalist (declining))
  (R2 = 0.055)

Market-liberal axis rising slightly; nationalist axis declining -- market integration emphasis. Both axes show low R-squared -- treat both as 'stable with noise'.

---

## Pre-Budget News Signal (2026)

Top vocabulary from PRS/EcoSurvey pre-budget coverage:

**mat, residents, units, corridors, disclosure, tcs, buybacks, depending, electronics, handloom, instruments, issuance, proi, promoters, stt, supplying, tourism, committee, mutual, bond**
